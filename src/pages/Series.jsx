...
const Series = () => {
    ...
    const renderListItem = (serie) => (
        <div key={serie[pageInfo.idKey]} className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-4 flex gap-4 border border-gray-700/50 hover:border-gray-600/50 transition-all">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-20 right-1/4 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl animate-pulse" />
                <div className="absolute top-1/2 left-1/4 w-80 h-80 bg-cyan-500/5 rounded-full blur-3xl animate-pulse"
                     style={{ animationDelay: '1.5s' }} />
                <div className="absolute bottom-1/4 right-1/3 w-72 h-72 bg-teal-500/5 rounded-full blur-3xl animate-pulse"
