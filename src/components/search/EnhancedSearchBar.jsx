...
const EnhancedSearchBar = ({
    ...
    const handleVoiceError = (error) => {
        ...
        // Potresti mostrare un toast o alert qui
    };
    ...
    return (
        <div className="relative w-full">
            ...
            {showDropdown && (
                <div
                    ref={dropdownRef}
                    className="absolute top-full z-50 mt-2 max-h-[32rem] w-full overflow-y-auto rounded-lg border border-gray-700 bg-gray-800 shadow-2xl"
                >
                    {loading ? (
                                    ...
                                    <div className="flex flex-wrap gap-2 px-2">
                                        {suggestions.map((suggestion, index) => (
                                            <button
                                                ...
                                                className="rounded-full bg-gray-700 px-4 py-2 text-sm text-white transition-colors hover:bg-gray-600"
                                            >
                                                {suggestion}
                                            </button>
                                        ))}
